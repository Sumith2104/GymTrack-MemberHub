...
import { UpdateProfilePictureForm } from '@/components/me/settings/update-profile-picture-form';
import Link from 'next/link';

export default async function SettingsPage({
  searchParams,
}: {
  searchParams: Promise<{ memberId?: string; email?: string; updated?: string }>;
}) {
